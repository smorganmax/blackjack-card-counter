                                                                                              ...
                                                                                              - - App icon and splash screen
                                                                                                - - Full-screen mode (no browser chrome)
                                                                                                  ...
                                                                                                  - ```
                                                                                                    ...
                                                                                                    ├── src/
                                                                                                    │   ├── components/
                                                                                                    │   │   ├── Game/           # Main game board components
                                                                                                    │   │   ├── Cards/          # Card display components
                                                                                                    │   │   ├── Controls/       # Player action buttons
                                                                                                    │   │   ├── Counter/        # Count training UI
                                                                                                    │   │   ├── Setup/          # Game setup/config screen
                                                                                                    │   │   └── Stats/          # Statistics display
                                                                                                    │   ├── hooks/
                                                                                                    │   │   ├── useGameState.js # Core game logic
                                                                                                    │   │   ├── useDeck.js      # Deck/shoe management
                                                                                                    │   │   └── useCounter.js   # Card counting logic
                                                                                                    │   ├── utils/
                                                                                                    │   │   ├── deck.js         # Deck creation, shuffling
                                                                                                    │   │   ├── blackjack.js    # Hand evaluation, rules
                                                                                                    │   │   ├── counting.js     # Hi-Lo counting system
                                                                                                    │   │   └── strategy.js     # Basic strategy chart
                                                                                                    │   ├── App.jsx
                                                                                                    │   ├── index.css
                                                                                                    │   └── main.jsx
                                                                                                    ├── index.html
                                                                                                    ...
                                                                                                    2. 2. Tap the Share button (square with arrow)
                                                                                                       3. 3. Scroll down and tap "Add to Home Screen"
                                                                                                          4. 4. Tap "Add" to confirm
                                                                                                             5. 5. The app will appear on your home screen like a native app
                                                                                                               
                                                                                                                6. ## Card Counting Quick Reference (Hi-Lo)
                                                                                                                ...
                                                                                                                12. **True Count** = Running Count ÷ Decks Remaining
